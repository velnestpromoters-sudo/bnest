  ...
  return (
    <div className="w-full flex flex-col pt-4">
      <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center mb-6 border border-white/20 mx-auto">
         <Mail className="w-8 h-8 text-[#ec38b7]" />
      </div>
      ...
      <div className="relative mb-4">
        <input 
          ...
          className="w-full bg-black/40 border border-white/20 text-white font-bold text-lg px-5 py-4 rounded-xl focus:outline-none focus:border-[#ec38b7] transition-colors text-center"
          autoFocus
        />
